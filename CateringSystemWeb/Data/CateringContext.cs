...
namespace CateringSystemWeb.Data
{
    public class CateringContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server=tcp:cateringsystemdb.database.windows.net,1433;Database=coreDB;User ID=chris;Password=Carrot31;Encrypt=true;Connection Timeout=30;");
        }
    }
}